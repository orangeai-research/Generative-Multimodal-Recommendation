...
class GaussianDiffusion(nn.Module):
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        return (#self.sqrt_alphas_cumprod 是每个step的值，--》将其与 x_start的形状对齐
            self._extract_into_tensor(self.sqrt_alphas_cumprod, t, x_start.shape).to(x_start.device) * x_start
            + self._extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape).to(x_start.device)
            * noise
        )
